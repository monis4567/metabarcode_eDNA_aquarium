...
#SBATCH --mem 96G ### or try with 8G if 4G is not enough
#SBATCH -c 4
#SBATCH -n 2
#SBATCH -t 1:00:00
#SBATCH -J p04_blibnumber_Lnumber
#SBATCH -o stdout_pa04_blast_blibnumber_Lnumber.txt
#SBATCH -e stderr_pa04_blast_blibnumber_Lnumber.txt
...
OUTFLN1="part04_blast_blibnumber_Lnumber.results.01.txt"
OUTFLN2="part04_blibnumber_Lnumber.DADA2_nochim.otus.fas"
