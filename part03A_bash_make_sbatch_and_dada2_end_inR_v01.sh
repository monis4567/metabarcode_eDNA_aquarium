...
do
	...
	sed "s/blibrarynumber/b"${fn}"/g" |
		sed "s/Lnumber/"${fl}"/g" > "${PATH01}"/"${BDR}"/part03_DADA2_end_190702_v01_b"${fn}"_"${fl}".r
	#character modify the r code to make it possible to execute the file
	chmod 755 "${PATH01}"/"${BDR}"/part03_DADA2_end_190702_v01_b"${fn}"_"${fl}".r
	...
	# replace "blibrarynumber"
	sed "s/blibrarynumber/b"${fn}"/g" |
		sed "s/Lnumber/"${fl}"/g" > "${PATH01}"/"${BDR}"/part03_sbatch_run_DADA2_end_v01_b"${fn}"_"${fl}".sh
...
do
	...
	sbatch part03_sbatch_run_DADA2_end_v01_b"${fn}"_"${fl}".sh
